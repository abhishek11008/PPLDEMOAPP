...
public class Answers {
    ...
    public static String[] Json1SalarySMSList = {"Rs. 49,566.00 is credited to your A/c XXXX8627  on 02-MAY-19 on account of Marriott Salary April 19 ."};//IDKOTAKB
    public static String[] Json2SalarySMSList = {"Hi, salary of INR 39,542.00 is credited to A/c XX8725. Avl bal: INR 47,683.89","Hi, salary of INR 39,542.00 is credited to A/c XX8725. Avl bal: INR 43,192.65","Hi, salary of INR 39,542.00 is credited to A/c XX8725. Avl bal: INR 40,942.33"};//AX-HDFCBK
    public static String[] Json3SalarySMSList = {"hi, salary of inr 21,451.00 is credited to a/c xx3920. avl bal: inr 21,522.85","Hi, salary of INR 21,451.00 is credited to A/c XX3920. Avl bal: INR 22,371.03."}; //MD-HDFCBK
    public static String[] Json4SalarySMSList = {"your a/c 403592 is credited with rs. 12415 on 28jun19. avbl bal: rs. 2421.17. info: brn-salary payment-epicenter techno"};//AD-AxisBk
    public static String[] Json5SalarySMSList = {"Dear Customer, your Account XX284 has been credited with INR 12,506.00 on 10-Jun-19. Info: NEFT-001ONCF191610018-BUREAU. Available Balance: INR 12,509.00"};//AX-ICICIB
    public static String[] Json6SalarySMSList = {"your sb a/c **********16329 is credited by rs. 17970 on 06-05-2019 by neft.sender:m/s pay asia managem. utr no:sin02017q0359430. avbl bal rs:17975.85"};//HP-UNIONB
    public static String[] Json7SalarySMSList = {"UPDATE: INR 14,311.00 deposited in A/c XX0740 on 07-MAY-19 for NEFT Cr-UTIB0000056-GLOBIVA SERVICES PRIVATE LIMITED-Jatin Goel-AXISP00050930933.Avl bal:INR 14,335.31 subject to clearing"};//AX-HDFCBK
    public static String[] Json8SalarySMSList = {"INR 15,529.44 credited to your A/c No XXXXXXX2467 on 02/07/19 through NEFT with UTR 907023278234 by TATA STEEL LTD 884"};//MD-SBIPSG
    public static String[] Json9SalarySMSList = {"UPDATE: INR 19,975.00 deposited in A/c XX2761 on 28-JUN-19 for NEFT Cr-DEUT0797BGL-CONCENTRIX SERVICES INDIA PRIVATE LIMITED-Swaraj Mohanty-190627236GN00638.Avl bal:INR 20,185.39 subject to clearing"};//ID-HDFCBK
    public static String[] Json10SalarySMSList = {"INR 16,317.00 is credited to A/C No.XX4505 on 31-MAY-19 10:07:05 - NEFT Cr-HDFC0004989-EXL SER COM INDIA P L 2448 Salary-Chirag Mangal-905300089665 .Tot avbl bal-16,318.11 on 31-May-19 10:07:10"};//VM-YESBNK



    //Existing EMIs
    public static String[] Json1ExisitngEMI = {"Hi, your Money View loan EMI of Rs. 6782.0 with our lending partner DMI Finance Pvt Ltd is due on 5th of this month. The EMI will be Auto-Debited from your account - SBIN-5243In case 5th is a non-working day for banks, it will get debited on the next working day.Please ensure you have enough balance in your linked bank account by 4th of the month.Thanks"};
    public static String[] Json2ExisitngEMI = {"Dear Customer, EMI of Rs. 5139 has been received for ABFL loan A/C no. LXS-B04218-190119735. Thank you for being a valued customer. Regards, ABFL."};
    public static String[] Json3ExisitngEMI = {"Hi Vinod Yadav, your repayment to EarlySalary of Rs. 7167.0 is due on 14-06-2019. Repay on time to avoid any penalties. Save interest & Repay today. bit.ly/2msPUJw"};
    public static String[] Json4ExisitngEMI = {"CB: Dear amit, the money is transferred to your account, please repay on time and unlock higher loan amount for next time!"};
    public static String[] Json5ExisitngEMI = {"Dear Mukesh, payment of Rs. 5074 is due by 2019-05-23. Pay on time to avoid penalty of Rs. 100. Pay via Bank Transfer/Debit Card/NetBanking/Paytm Wallet/UPI from the options in KreditBee app. Select Bank Transfer option to avoid convenience fees. Ignore if paid. https://kredt.be/app"};
    public static String[] Json6ExisitngEMI = {"Dear Customer, EMI of Rs 2562 of your DPL Loan no.5660715 is due on 4th Jul 19. Please ensure to have sufficient funds at least 1 day before due date for EMI clearance.pls ignore SMS if paid."};
    public static String[] Json7ExisitngEMI = {"Congratulations Jatin! your loan has been disbursed to your bank account xxxxxxxxxxx9582 after deduction of processing fees. Repay on time to avoid late payment charges! kredt.be/app"};
    public static String[] Json8ExisitngEMI = {"Dear Customer. Greetings from HDFC Bank. We wish to remind you that an EMI of Rs 8570.00 on your PERSONAL LOAN A/c xxx921 falls due on 07/07/2019. Request you to maintain sufficient balance in your EMI paying account. Thank you for banking with us.","Home Credit loan 3904318430 ki kisht Rs 4035.00 ka bhugtaan karne ke liye dhanywad, Trans ID HCCP19996592. Bhavishy mein App se pay karein bit.ly/2GOaDjx"};
    public static String[] Json9ExisitngEMI = {"[Wificash]Your repayment date is Jun 25 2019, and the repayment amount is 3000.0 rupees, please repay in time to avoid overdue. The Beneficiary's\u200B account information is as follows: Beneficiary's Account Name: Chadha Finance Limited; Beneficiary Bank Name: ICICI Bank; Beneficiary's\u200B Account No: 245105000738; IBAN/IFSC: ICIC0002451. Please fill your Mobile Number in the Remarks when you make the repayment. If you have already made the repayment, please ignore this message."};
    public static String[] Json10ExisitngEMI = {"Dear Chirag, Your EarlySalary Loan repayment amount of RS 7546 is due on 2019-06-01. Direct debit configuration with your bank account is pending for your signature. Please repay via Netbanking/UPI/IMPS/NEFT using EarlySalary mobile app to avoid any charges. For any help chat with us on our App. bit.ly/2msPUJw"};
